                        ...
                        <div class="col-12 d-flex py-1">
                            <div class="col-12 pe-2">
                                <div class="container_posts col-12 d-flex row align-items-center mx-auto">
                                    ...
                                    <div class="imagem_posts col-4 col-md-3" style="width:10rem; height: 12rem; background-size: cover; background-position: center top; background-image: url(<?php echo get_the_post_thumbnail_url(get_the_ID(),'medium'); ?>)"></div>
